...
var printProduct = product => {
    ...
    input.addEventListener("change", (event) => {
        ...
        document.getElementById("button").disabled = buttonDisabled(products);
    })
...
var bill = (products) => {return subtotalBill(products) + taxTotal(products)};
...
var buttonDisabled = (productList) => { 
    for (var product of productList) {
    if (product.units > 0) {
      return  false;
    }
